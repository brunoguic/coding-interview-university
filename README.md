...
Intro removed.. checkout on branch master,

## Table of Contents

- [Algorithmic complexity / Big-O / Asymptotic analysis](#algorithmic-complexity--big-o--asymptotic-analysis)  ![Progress](http://progressed.io/bar/25)
...
- ### Linked Lists
    ...
    - Implementation with sentinel:
        - [ ] All operations above with a sentinel node NULL
    - [ ] Doubly-linked List
...
- ### Combinatorics (n choose k) & Probability
    ...
    - [x] [Lessons about Permutation and Combinations](http://doubleroot.in/lessons/permutations-combinations/)
